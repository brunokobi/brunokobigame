    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        ...
        style={{
          ...
          background:
            'radial-gradient(ellipse at center, hsl(var(--nebula-core) / 0.4) 0%, hsl(220 70% 40% / 0.2) 40%, transparent 70%)',
          filter: 'blur(60px)',
      ...
      <div
        ...
        style={{
          ...
          background:
            'radial-gradient(ellipse at center, hsl(var(--nebula-light) / 0.3) 0%, hsl(var(--nebula-core) / 0.15) 50%, transparent 70%)',
          filter: 'blur(50px)',
      ...
      <div
        ...
        style={{
          ...
          background:
            'radial-gradient(ellipse at center, hsl(var(--neon-green) / 0.15) 0%, hsl(180 50% 35% / 0.1) 50%, transparent 70%)',
          filter: 'blur(70px)',
      ...
      <div
        ...
        style={{
          ...
          background:
            'radial-gradient(circle, hsl(var(--neon-green) / 0.15) 0%, transparent 60%)',
          filter: 'blur(40px)',
