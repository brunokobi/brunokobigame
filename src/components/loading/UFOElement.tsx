    ...
    >
      ...
      <div className="relative animate-float">
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(180deg, hsl(220 60% 25%) 0%, hsl(230 50% 15%) 100%)',
            boxShadow: `
              inset 0 2px 10px hsl(200 80% 60% / 0.3),
              0 0 30px hsl(140 100% 50% / 0.3),
              0 0 60px hsl(140 100% 50% / 0.15)
            `,
          }}
        >
          {/* UFO dome */}
          <div 
            ...
            style={{
              background: 'linear-gradient(180deg, hsl(200 80% 60% / 0.3) 0%, hsl(220 60% 30% / 0.5) 100%)',
              boxShadow: 'inset 0 -2px 10px hsl(200 80% 60% / 0.2)',
            }}
          />
            ...
            {[...Array(5)].map((_, i) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 8px hsl(140 100% 50% / 0.8)',
                }}
              />
            ))}
          </div>
        ...
        <div 
          ...
          style={{
            width: '60px',
            height: '150px',
            background: 'linear-gradient(180deg, hsl(140 100% 50% / 0.3) 0%, hsl(140 100% 50% / 0.05) 100%)',
